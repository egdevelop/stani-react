...
class Dashboard extends Component{
    ...
    getRekom(){
        fetch("http://staniv2.ddns.net:5001/api/v1/stani/rekom/EGDEVoPoqqs1jj23n",{
            method: "POST",
            headers: {
    ...
    popupTanamans(a){
        ...
        pilih.addEventListener("click",()=>{
            fetch("http://staniv2.ddns.net:5001/api/v1/stani/pilih/EGDEVoPoqqs1jj23n",{
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
                    ...
                    <div className="table mt-3 mb-3">
                        <div className="card-table-head bg-hijau">
                            ...
                            <div className="img-detail-tanaman mr-3">
                                ...
                                <button className="btn btn-block mt-1 bg-merah" onClick={()=>{
            fetch("http://staniv2.ddns.net:5001/api/v1/stani/selesai/EGDEVoPoqqs1jj23n",{
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
        ...
        .then((hasil) => {
            console.log(hasil);
                            ...
                            <div className="text-detail-tanaman">
                                <h3>Jagung</h3>
                                <p className="mb-1 kecil">Jagung adalah salah satu tanaman pangan penghasil karbohidrat yang terpenting 
                                di dunia, selain gandum dan padi. Bagi penduduk Amerika Tengah dan Selatan, 
                                bulir jagung adalah pangan pokok, sebagaimana bagi sebagian penduduk Afrika dan beberapa daerah di Indonesia.</p>
                                <h4 className="mb-1">Ketersediaan Video Pembelajaran</h4>
                                <div className="row">
                                    <img className="tubnail-yt-sm" src="https://i.ytimg.com/vi/1CSlqOqjKpM/maxresdefault.jpg" alt="tubnail-yt"/>
                                    <img className="tubnail-yt-sm" src="https://8villages-dashboard.s3.amazonaws.com/1583463035-362-191265.jpg" alt="tubnail-yt"/>
                                    <img className="tubnail-yt-sm" src="https://i2.wp.com/gdmorganic.com/wp-content/uploads/2020/09/IMG20170921110106-1024x600.jpg" alt="tubnail-yt"/>
                                </div>
                            </div>
                        </div>
                                </div>
                        ...
                        {this.state.dataRekom.map((rekom , index) => (
                            <div key={rekom.id} className="item-stani" onClick={()=>this.popupTanamans(index)}>
