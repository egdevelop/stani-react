...
class Forum extends Component{
    constructor(props) {
      ...
      getPost(){
        fetch("http://staniv2.ddns.net:5001/api/v1/stani/forum/EGDEVoPoqqs1jj23n")
        .then((res) => res.json())
        .then((body) => {
            this.setState({
                dataPost: body
            ...
            <Fragment>
                ...
                <div className="konten">
                    <div className="container">
                      ...
                      placeholder="Ketikan Sesuatu....."></textarea>
                        <span onClick={this.postForum} className="hijau none-style float-right">Tanam</span>
