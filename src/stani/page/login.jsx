...
class Login extends Component{
    constructor(props) {
      ...
      postLogin = () => {
        fetch("http://staniv2.ddns.net:5001/api/v1/stani/login/EGDEVoPoqqs1jj23n", {
          method: "POST",
          headers: {
                            ...
                            <div className="img-login">
                                ...
                                <div className="login-wrapper ml-3">
                                        <div className="center">
                                            ...
                                            <div className="input-group">
                                            <button onClick={this.handleSubmit} className="btn btn-block bg-hijau-muda mb-1">Login</button>
                                            <p className="bold kecil">Tidak punya akun <Link to="/regis">Klik disini</Link></p>
                                            </div>
                                        </div>
                                </div> 
                            </div>                
